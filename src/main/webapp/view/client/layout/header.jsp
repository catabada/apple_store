...
<%--                            </c:forEach>--%>
            ...
            <%--            %>--%>
            <%--            <c:if test="${user == null}">--%>
            <%--                <a href="/sign-in" class="header-navbar__icon header-navbar__icon--user">--%>
            ...
            <%--                            height="35">${fn:substring(user.getFirst().toUpperCase(),0,1)}${fn:substring(user.getLast().toUpperCase(),0,1)}--%>
            <%--                    </canvas>--%>
